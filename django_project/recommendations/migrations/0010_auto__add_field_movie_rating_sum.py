...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.rating_sum'
        db.add_column(u'recommendations_movie', 'rating_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.rating_sum'
        db.delete_column(u'recommendations_movie', 'rating_sum')
