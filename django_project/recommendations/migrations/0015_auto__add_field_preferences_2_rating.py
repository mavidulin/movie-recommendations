...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preferences_2.rating'
        db.add_column(u'recommendations_preferences_2', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Preferences_2.rating'
        db.delete_column(u'recommendations_preferences_2', 'rating')
