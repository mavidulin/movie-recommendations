...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Preferences_2'
        db.create_table(u'recommendations_preferences_2', (
        ...
        db.send_create_signal(u'recommendations', ['Preferences_2'])


    def backwards(self, orm):
        # Deleting model 'Preferences_2'
        db.delete_table(u'recommendations_preferences_2')
